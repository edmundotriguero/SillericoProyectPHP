<?php $__env->startSection('contenido'); ?>
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			<?php echo Form::open(array('url'=>'almacen/tela','method'=>'POST','autocomplete'=>'off')); ?>
			...
			<div class="form-group text-center">
			    ...
			    <a href="<?php echo e(action('TelaController@index')); ?>"><div class="btn btn-info" ><i class="fa fa-reply-all" aria-hidden="true"></i></div></a>
