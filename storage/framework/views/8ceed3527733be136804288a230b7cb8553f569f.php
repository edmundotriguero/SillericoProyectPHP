	...
	<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
		<div class="form-group">
			...
			<select name="idlote" class="form-control">
				...
				<?php if($lote->id==$producto->lote): ?>
				<option value="<?php echo e($lote->id); ?>" selected><?php echo e($lote->lote); ?></option>
				<?php else: ?>
...
<div class="row">
	<div class="col-lg-4 col-sm-4 col-md-4 col-xs-10">
		<div class="form-group">
			...
			<select name="idcategoria" class="form-control">
				...
				<?php if($cat->idcategoria==$producto->idcategoria): ?>
	...
	<div class="col-lg-4 col-sm-4 col-md-4 col-xs-10">
		<div class="form-group">
			<label>Codigo</label>
			<input type="text" name="codigo" class="form-control" value="<?php echo e($producto->codigo); ?>"
...
<div class="row text-center">
	<div class="form-group">
		...
		<a href="<?php echo e(action('ProductoController@index')); ?>">
