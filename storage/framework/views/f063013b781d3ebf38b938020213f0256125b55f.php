...
<?php echo Form::open(array('action'=>'VentasController@storeSaldos','method'=>'POST','autocomplete'=>'on')); ?> <?php echo e(Form::token()); ?>
...
<?php echo Form::close(); ?> <?php $__env->startPush('scripts'); ?>
<script>
