	...
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="table-responsive">
				...
				<?php foreach($movimientos as $mov): ?>
					<tr>
						...
						<?php foreach($sucursales as $suc): ?>
							<?php if($suc->idsucursales == $mov->idSucOrigen): ?>
							<td><?php echo e($suc->nombre); ?></td>
							
							<?php endif; ?>
						<?php endforeach; ?>
						<?php foreach($sucursales as $suc): ?>
							<?php if($suc->idsucursales == $mov->idSucDestino): ?>
							<td><?php echo e($suc->nombre); ?></td>
				...
				<?php echo $__env->make('almacen.movimiento.modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>  
					<?php endforeach; ?>
				</table>
			</div>
